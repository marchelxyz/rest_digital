        ...
        <div className="rounded-xl border border-neutral-200 p-4 space-y-4">
          ...
          <div className="grid gap-3">
            ...
            <div className="space-y-3 rounded-lg border border-amber-100 bg-amber-50/50 p-3">
              ...
              <p className="text-xs text-muted-foreground">
                Достаточно API-ключа и организации: сначала пробуется внешнее меню (POST /api/2/menu +
                by_id), затем номенклатура. Если в iikoWeb у внешнего меню источник цен — «базовый
                прайс-лист», в ответе API часто нет <span className="font-mono">priceCategoryIds</span>
                ; для меню вида <span className="font-mono">76108#2</span> укажите UUID категории цен
                вручную (iikoOffice: скидки и цены → категории цен) или смените источник цен на
                конкретную категорию в карточке внешнего меню. Сохраните настройки перед синхронизацией.
              </p>
            </div>
